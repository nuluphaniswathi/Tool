...
export const fetchFilteredAssumptionLogs = async (gdo, projects, status) => {
    ...
    return axios({
        method: "GET",
        url: `/assumptions${queryParams ? `?${queryParams}` : ""}`
    });
}

export const downloadAssumptionReport = async (selectedGDO, selectedProjects,selectedStatus) => {
    const axios = getAxiosInstance();
    ...
    return axios({
        method: "GET",
        url: `/assumptions/download_assumptions`,
        params: params,
        responseType: "blob",
    });
}